    ...
    def get_upper_triangle_matrix(matrix, results):
        ...
        for column_no in range(matrix_idx):
            for row_no in range(matrix_idx, matrix_idx_count, -1):
                ...
                matrix_np[row_no] = MatrixDecomposition.substract_rows(matrix_np[column_no], matrix_np[row_no], multipy_coeficient)
                results_np[row_no] = MatrixDecomposition.substract_results(results_np, row_no, column_no, multipy_coeficient)
            matrix_idx_count += 1
